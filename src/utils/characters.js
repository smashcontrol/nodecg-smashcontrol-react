...
const ssbm_character_list = ssb64_character_list.slice(0, 11).concat(["Peach", "Bowser", "Marth", "Zelda", "Sheik", "Ganondorf", "Falco", "Ice Climbers",
    "Mr. Game and Watch", "Dr. Mario", "Young Link", "Mewtwo", "Roy"]);

const ssbb_character_list = ssbm_character_list.slice(0, -4).concat(["Diddy Kong", "Meta Knight", "King Dedede", "Toon Link", "Zero Suit Samus", "Charizard",
    "Lucario", "Lucas", "Ike", "Wario", "Pit", "Olimar", "ROB", "Sonic", "Snake",
    "Wolf", "Pokemon Trainer", "Squirtle", "Ivysaur"]);

const ssbpm_character_list = ssbb_character_list.concat(["Mewtwo", "Roy"]);

const ssb4_character_list = ssbb_character_list.slice(0, -5).concat(["Dr. Mario", "Mewtwo", "Roy", "Rosalina", "Bowser Jr.", "Roy Koopa", "Wendy", "Iggy", "Lemmy", "Morton", "Ludwig", "Larry", "Greninja",
...
const ssbult_character_list = ssb4_character_list.concat(["Ice Climbers", "Young Link", "Snake", "Wolf", "Pokemon Trainer Male", "Pokemon Trainer Female", "Squirtle",
